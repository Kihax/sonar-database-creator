...
dt = get_tree_from_file("database_3000x200_full_track.nc", "../")
dts = [dt]
...
filtered_positions = rdi.get_groups_with_n_imagettes_containing_point(
    global_imagettes, Point(402442.49520781595, 4654279.884892509), 36
)


# Boucle principale : affiche une position après l'autre
for coord, list_imagettes in filtered_positions.items():
