...
imagettes : List[Imagette] = rb.extract_imagette(sonarPings, Point(eastering, northering), max_dist=0.3, width=3000, height=200, get_all=False, strict_single_file=True)
