...
def get_files(folder_path):
    """
        Returns all filename in the given folder
...
def get_tree_from_index(file_index, folder_path):
    """
    ...
    """
    # load data
    file_path = os.path.abspath(os.path.dirname(__file__)) + folder_path # we can run this file from any directory in terminal
...
def get_tree_from_file(filename, folder_path):
    """
        Open DataTree from given netcdf file
        Args:
            - file_index (int) : number of the file from get_files('/../../Dataset Metric/')
    ...
    """
    # load data
    file_path = os.path.abspath(os.path.dirname(__file__)) + "/../" + folder_path + filename # we can run this file from any directory in terminal
